...
export default function Sidebar({
    ...
    <div key={layer.id} className="p-3 flex flex-col gap-2 hover:bg-slate-50 dark:hover:bg-slate-800/60 transition-colors">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2.5 min-w-0">
          ...
          <div className="flex items-center space-x-1.5 min-w-0">
            ...
            {layer.type === "unknown" && (
              <span className="w-3 h-3 bg-slate-300 dark:bg-slate-700 border border-slate-400 dark:border-slate-600 inline-block shrink-0" />
            )}
      ...
      {layer.visible && (
        <div className="flex items-center gap-3 pl-8 pb-1 pt-0.5">
          ...
          <div className="flex items-center gap-1.5 shrink-0 bg-slate-100 dark:bg-slate-800 rounded-md px-1.5 py-0.5 border border-slate-200 dark:border-slate-700">
            <div className="relative w-4 h-4 rounded overflow-hidden border border-slate-300 dark:border-slate-600 shadow-sm shrink-0">
              <input
                type="color"
                id={`color-${layer.id}`}
            ...
            <input
              ...
              value={layer.color}
              onChange={(e) => updateLayerColor(layer.id, e.target.value)}
              className="w-14 text-[10px] font-mono font-bold bg-transparent border-0 p-0 text-slate-700 dark:text-slate-200 uppercase focus:ring-0 focus:outline-none"
              placeholder="#FFFFFF"
  ...
  return (
    <aside className="w-80 border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 flex flex-col h-full shrink-0 shadow-sm font-sans transition-colors">
      {/* Sidebar Header */}
      <div className="p-4 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="p-1.5 text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition duration-150 border border-transparent cursor-pointer"
          >
          ...
          {!isLayersCollapsed && (
            <div className="space-y-4">
              ...
              {administrativeLayers.length > 0 && (
                <div className="border border-slate-200 dark:border-slate-800 rounded-lg overflow-hidden bg-slate-50/30 dark:bg-slate-900/30 shadow-sm">
                  <button
                    onClick={() => setIsAdminCollapsed(!isAdminCollapsed)}
                    className="w-full flex items-center justify-between p-2.5 bg-slate-100/80 dark:bg-slate-800/80 hover:bg-slate-200/60 dark:hover:bg-slate-700/60 transition-colors text-left font-sans focus:outline-none border-b border-slate-200/60 dark:border-slate-800/60 cursor-pointer"
                  >
              ...
              {otherLayers.length > 0 && (
                <div className="border border-slate-200 dark:border-slate-800 rounded-lg overflow-hidden shadow-sm">
                  <div className="p-2.5 bg-slate-100/50 dark:bg-slate-800/50 border-b border-slate-200/60 dark:border-slate-800/60">
              ...
              {layers.length === 0 && (
                <div className="p-6 text-center text-xs text-slate-400 font-medium bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-sm">
              ...
              {baseMaps.map((map) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="h-14 w-full rounded-md mb-1.5 overflow-hidden border border-slate-100 dark:border-slate-800 flex items-center justify-center relative">
        ...
        <div className="space-y-3 pt-2">
          ...
          {!isMeasureCollapsed && (
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-sm p-3.5 space-y-4">
              ...
              {measureMode === "none" ? (
                <div className="text-center p-3 py-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-100/70 dark:border-slate-700/50">
                ...
                <div className="space-y-3.5">
                  <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50 p-3 rounded-lg space-y-2">
      ...
      <div className="p-3 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
        <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700/60 rounded-md p-2 flex flex-col gap-1 text-[11px] text-slate-500 dark:text-slate-400 font-medium">
          ...
          <div className="flex justify-between">
            <span>District (Haridwar):</span>
            <span className="font-mono text-slate-700 dark:text-slate-200 font-bold">068</span>
          </div>
        </div>
      </div>
    </aside>
