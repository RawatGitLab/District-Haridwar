...
export default function MapComponent({
  ...
  useEffect(() => {
    ...
    // Center on Haridwar, Uttarakhand, India (Haridwar: 29.9457, 78.1642)
  ...
  // Map Controls: Pan to Haridwar bounds safely
  const handleZoomToDistrict = () => {
    ...
    // Fallback static center of Haridwar
    map.setView([29.9457, 78.1642], 10, { animate: true });
  };
