...
An interactive, map-based portal for **Haridwar District**, built with React, TypeScript, Leaflet, and the Google Gemini API. The app lets citizens and administrators explore geospatial data, layers, and district information through a fast, modern web interface.
...
For queries or issues related to this project, reach out via the repository's [Issues](https://github.com/RawatGitLab/District-Haridwar/issues) page.

---

<p align="center">Built for Haridwar District 🏔️</p>
